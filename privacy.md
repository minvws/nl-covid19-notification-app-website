...
De DKs worden gedeeld via de Europese Federatieve Gateway Service (EFGS) met andere Europese landen die een app hebben met vergelijkbaar beveiligingsniveau en zich aan hebben gesloten bij de EFGS. Aansluiten bij de EFGS gaat stap voor stap. Een actueel overzicht van de deelnemende landen vindt u bij het onderdeel “[CoronaMelder en het buitenland](https://coronamelder.nl/nl/faq/13-gebruik-app-uit-ander-land/)” in de veel gestelde vragen op CoronaMelder.nl. De EFGS wordt beheerd door de Europese Commissie (verwerker). De technische en organisatorische voorwaarden om aan te sluiten bij de EFGS staan in het [Europees uitvoeringsbesluit voor grensoverschrijdende uitwisseling](https://eur-lex.europa.eu/eli/dec_impl/2020/1023/oj). Meer informatie over interoperabiliteit met andere landen kunt u vinden op [eHealth and COVID-19](https://ec.europa.eu/health/ehealth/covid-19).
